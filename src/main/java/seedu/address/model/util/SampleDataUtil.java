...
public class SampleDataUtil {
    public static Person[] getSamplePersons() {
        return new Person[] {
                new Person.PersonBuilder("Alex Yeoh")
                        .phone("87438807")
                        ...
                        .build(),
                new Person.PersonBuilder("Bernice Yu")
                        .phone("99272758")
                        ...
                        .pairedPersons(new ArrayList<>())
                        .build(),
                new Person.PersonBuilder("Charlotte Oliveiro")
                        .phone("93210283")
                        ...
                        .pairedPersons(new ArrayList<>())
                        .build(),
                new Person.PersonBuilder("David Li")
                        .phone("91031282")
                        ...
                        .pairedPersons(new ArrayList<>())
                        .build(),
                new Person.PersonBuilder("Irfan Ibrahim")
                        .phone("92492021")
                        ...
                        .pairedPersons(new ArrayList<>())
                        .build(),
                new Person.PersonBuilder("Roy Balakrishnan")
                        .phone("92624417")
